...
{	// Variable declarations
	...
	{	
		System.out.println("From [1]-[4], Please choose difficulty level");
		generateQuestionArgument(readDifficulty());
	}
	...
	public static void generateQuestionArgument(int difficultyLevel)
	{
